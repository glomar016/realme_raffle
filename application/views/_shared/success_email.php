...
<div style="background-image:url('<?php echo base_url()?>assets/img/background_2.png');background-position:center top;background-repeat:repeat;background-color:#091548;">
...
<p style="margin: 0;font-family:Varela Round, Trebuchet MS, Helvetica; text-align: center; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                    Congratulations! <br>
													You earned one raffle entry to realme Fan Festival 2021 Raffle Promo <br>
													with a reference number of <font color="yellow"> <?php echo str_pad($id, 6, '0', STR_PAD_LEFT) ?> </font>
													<br><br>
													Please stay tuned in our Facebook page <a href="https://facebook.com/realmePhilippines">realme Philippines</a><br>
													as we will draw the lucky winners on September 4, 2021!<br>
													We will be sending a text message to the winners so please keep<br> your registered phone number active.<br><br>
        	            							realme Philippines
...
<!-- <img align="center" border="0" class="center fixedwidth" src="<?php echo base_url()?>assets/img/Raffle-Promo-600x155.jpg" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 435px; max-width: 100%; display: block;" width="435"/> -->
<!--[if mso]></td></tr></table><![endif]-->
</div>
<table border="0" cellpadding="0" cellspacing="0" class="divider" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;" valign="top" width="100%">
<tbody>
