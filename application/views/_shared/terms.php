...
<li>Customer is entitled for one (1) raffle entry for every qualified realme smartphone purchased. Multiple entries are also allowed.</li>
<li>Entry will only be considered valid once a confirmation email has been sent to the registered email address. Only completed forms with valid entries will be qualified. Entries must come from citizens of legal age and confirmed with valid government IDs.</li>
<li>The winners should provide at least two (2) valid Identification for validation when claiming the prize.</li>
<li>All prizes are tax-free, non-transferrable and non-convertible to cash.</li>
<li>Only valid receipts and a 15-digit IMEI1 number will be allowed on the form.</li>
...
<li>Validity will be check thru the purchased date specified in uploaded official receipt</li>
<li>A DTI representative will be invited to check the computer system for the promo and another DTI representative to witness the raffle draw.</li>
</ul>
</div>
